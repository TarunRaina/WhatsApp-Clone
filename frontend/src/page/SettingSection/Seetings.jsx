              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <span className="ml-auto text-sm text-gray-400">{theme.charAt(0).toUpperCase() + theme.slice(1)}</span>
                     ...
                     {/* Logout Button */}
            <button onClick={handleLogout} className={` w-full flex items-center gap-3 p-2 rounded text-red-500 ${theme === "dark" ? "hover:bg-[#202c33]" : "hover:bg-gray-100"} mt-10 md:mt-36`}>
